 ...
 */
    ...
    class QRcode {
        ...
        //----------------------------------------------------------------------
        public static function png($text, $outfile = false, $level = QR_ECLEVEL_L, $size = 3, $margin = 4, $saveandprint=false, $back_color = 0xFFFFFF, $fore_color = 0x000000, $styles = array ())
        {
            $enc = QRencode::factory($level, $size, $margin, $back_color, $fore_color, $styles);
    ...
    class QRencode {
        ...
        //----------------------------------------------------------------------
        public static function factory($level = QR_ECLEVEL_L, $size = 3, $margin = 4, $back_color = 0xFFFFFF, $fore_color = 0x000000, $styles)
        {
            $enc = new QRencode();
            $enc->size = $size;
            $enc->margin = $margin;
        ...
        public function encodePNG($intext, $outfile = false,$saveandprint=false)
        {
            try {
                ...
                QRimage::png($tab, $outfile, min(max(1, $this->size), $maxSize), $this->margin,$saveandprint, $this->back_color, $this->fore_color, $this->styles);
